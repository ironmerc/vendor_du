...
DU_VERSION := DU-$(DU_BUILD_TYPE)-$(PLATFORM_VERSION)-$(DU_BUILD)-$(BUILD_DATE)-$(BUILD_TIME)
TARGET_BACON_NAME := $(DU_VERSION)
ROM_FINGERPRINT := DU/$(DU_BUILD_TYPE)/$(PLATFORM_VERSION)/$(BUILD_ID)/$(BUILD_DATE)/$(BUILD_TIME)
